export const proseClasses =
  ...
  "prose-h1:text-3xl prose-ul:my-3 prose-ol:my-3 prose-p:mb-1 prose-p:leading-5 md:prose-p:mb-2 md:prose-p:leading-6 prose-li:my-1 prose-li:leading-5 md:prose-li:leading-6";
