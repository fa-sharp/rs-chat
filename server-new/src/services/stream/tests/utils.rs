use super::super::tinistream::TinistreamClient;

pub fn setup_tini_client() -> TinistreamClient {
    let url = dotenvy::var("RS_CHAT_TINISTREAM_URL").unwrap_or("http://127.0.0.1:8081".to_owned());
    ...
    let tini_client = tinistream_client::Client::new_with_client(&url, tini_http_client.clone());
    TinistreamClient::new(tini_client)
}
